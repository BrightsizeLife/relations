...
export const PLANNED = [
  ...
  { title: 'factor analysis', after: 'measurement', note: 'when several indicators share one unobserved cause, and how many causes there are' },
  { title: 'cluster analysis', after: 'correlation', note: 'k-means, hierarchical and density-based — three different answers to "which of these belong together"' },
